...
import DomainModelExplainer from '../components/DomainModelExplainer'
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      if (!state.hasBeenSetup) {
        ...
        await zkappWorkerClient.loadRecursion()
        await zkappWorkerClient.loadBlackmask()
  ...
  if (state.hasBeenSetup && state.accountExists) {
    mainContent = (
      <div style={{ justifyContent: 'center', alignItems: 'center' }}>
        ...
        <button className="" onClick={onRefreshCurrentNum}>
          Get Latest State
        </button>
      </div>
    )
  ...
  return (
    <DynamicBG>
      ...
      <div className=" text-white text-center text-9xl py-40">zk IMAGE</div>
      {/* </div> */}
      <ExplainerComponent />
