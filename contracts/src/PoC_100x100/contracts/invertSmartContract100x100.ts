import { SmartContract, state, method, State, Field, Provable } from 'o1js';
import { NewImageSize100x100 } from '../classes/imageClass100x100.js';
...
export class Invert extends SmartContract {
  ...
  @method invert(image: NewImageSize100x100) {
